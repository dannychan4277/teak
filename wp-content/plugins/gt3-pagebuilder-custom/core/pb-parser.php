...
function get_pb_parser($gt3pb_modules)
{
    global $gt3pb_lineWidth; $compile = "";
    if (!is_array($gt3pb_modules)) {$gt3pb_modules=array();}
    $allModulesCount = count($gt3pb_modules);
    $normalModulesCount = 0;
    $allModulesICounter = 0;
    $normalModulesICounter = 0;

    #Count normal modules
    foreach ($gt3pb_modules as $module_key => $module) {
    ...
    foreach ($gt3pb_modules as $module_key => $module) {
        ...
        if ($module['name']=="bg_start" || $module['name']=="bg_end") {
            ...
            if ($normalModulesICounter == 1 || $gt3pb_lineWidth >= 1) {
                $gt3pb_lineWidth = 0;
            ...
            switch ($module['name']) {
                ...
                #NEW MODULE
                case "gt3_sidebar":
                    $compile .= do_shortcode("[gt3_sidebar
                    heading_alignment='".$module["heading_alignment"]."'
                    heading_color='".$module["heading_color"]."'
                    heading_size='".$module["heading_size"]."'
                    widget_sidebar='".$module["widget_sidebar"]."'
                    heading_text=\"".$module["heading_text"]."\"
                    ][/gt3_sidebar]");
                    break;
                #BREAK
                ...
                case "content":
                    ...
                    $gt3pb_contentAlreadyPrinted = true;
                    break;
                #BREAK
                ...
                case "blog":
                    ...
                    if (!isset($module["pager_type"])) {$module["pager_type"] = '';}
                    $compile .= do_shortcode("[blog
                    heading_alignment='".$module["heading_alignment"]."'
                    heading_color='".$module["heading_color"]."'
                    heading_size='".$module["heading_size"]."'
                    heading_text=\"".$module["heading_text"]."\"
                    blog_type=\"".$module["blog_type"]."\"
					pager_type=\"".$module["pager_type"]."\"
                ...
                case "diagramm":
                    ...
                    if (isset($module["module_items"]) && is_array($module["module_items"])) {
                        ...
                        foreach ($module["module_items"] as $diagkey => $diag_item) {
							$diagcompile .= "[diagramm_item padding_between_items='".$module["padding_between_items"]."' diag_width='".$diag_width."' bar_width='".$module['bar_width']."' diagram_bg='".$module['diagram_bg']."' diagram_color='".$module['diagram_color']."' percent='".$diag_item['percent']."' diag_title='".$diag_item['title']."']".(isset($diag_item['description']) ? $diag_item['description'] : "")."[/diagramm_item]";
                        }
                    }
					...
					percent_size='".(isset($module["percent_size"]) ? $module["percent_size"] : "")."'
					diagram_size='".(isset($module["diagram_size"]) ? $module["diagram_size"] : "")."'
                    heading_color='".$module["heading_color"]."'
                    heading_size='".$module["heading_size"]."'
                    heading_text=\"".$module["heading_text"]."\"
                ...
                case "portfolio_masonry":
                    ...
                    heading_text=\"".$module["heading_text"]."\"
                    posts_per_page='".$module["posts_per_page"]."'
                    filter='".(isset($module["filter"]) ? $module["filter"] : "off")."'
                    selected_categories='".implode(",", $compile_cats)."'
                    ][/portfolio_masonry]");
                    break;
                #BREAK
