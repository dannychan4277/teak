    ...
    <div class='padding-cont'>
        ...
        <div class='alignment'>
            ...
            <select class='newselect' name='pagebuilder[modules][$moduleid][heading_alignment]'>
                " . gt3pb_get_select_options($GLOBALS["pbconfig"]['all_available_headers_alignment'], $gt3_theme_pagebuilder['modules'][$moduleid]['heading_alignment']) . "
            </select>
        </div>
        <div class='heading_size'>
            <h4>" . __('Size', 'gt3_builder') . "</h4>
            <select class='newselect' name='pagebuilder[modules][$moduleid][heading_size]'>
                " . gt3pb_get_select_options($GLOBALS["pbconfig"]['all_available_headers_for_module'], $pb_module_size_now) . "
            </select>
        </div>
        <div class='heading_color'>
            <h4>" . __('Color', 'gt3_builder') . "</h4>
            " . gt3pb_colorpicker_block("pagebuilder[modules][$moduleid][heading_color]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['heading_color']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['heading_color'] : '')) . "
        </div>
        <div class='clear'></div>
    </div>
    ...
    return "
        <div class='enter_option_row'>
            ...
            <select class='newselect' name='pagebuilder[modules][$moduleid][$settingname]' style='width:{$width} !important;'>
                " . gt3pb_get_select_options($available_options_in_select, (isset($gt3_theme_pagebuilder['modules'][$moduleid][$settingname]) ? $gt3_theme_pagebuilder['modules'][$moduleid][$settingname] : '')) . "
            </select>
        </div>
    ";
}
...
function get_module_settings_part_select_with_caption($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $temp, $headingtext, $settingname, $width, $available_options_in_select)
{
    return "
        <div class='enter_option_row'>
            <h5>$headingtext</h5>
            <select class='newselect' name='pagebuilder[modules][$moduleid][$settingname]' style='width:{$width} !important;'>
                " . gt3pb_get_select_options_with_caption($available_options_in_select, (isset($gt3_theme_pagebuilder['modules'][$moduleid][$settingname]) ? $gt3_theme_pagebuilder['modules'][$moduleid][$settingname] : '')) . "
            </select>
        </div>
    ";
}
    ...
    return "
        <div class='enter_option_row'>
            ...
            <select class='newselect " . $classes . "' name='' style='width:{$width} !important;'>
                " . gt3pb_get_select_options_with_caption($available_options_in_select, '') . "
            </select>
        </div>
    ";
}
