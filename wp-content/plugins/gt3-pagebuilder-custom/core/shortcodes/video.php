	...
	public function register_shortcode($shortcodeName) {
		function shortcode_video($atts, $content = null) {
			...
			if ($is_youtube > 0) {
				...
				$compile = "
            <iframe width=\"100%\" height=\"".$h."\" src=\"http://www.youtube.com/embed/" . $videoid . "\" frameborder=\"0\" allowfullscreen></iframe>
        ";
			}
			...
			if ($is_vimeo > 0) {
				...
				$compile = "
            <iframe src=\"http://player.vimeo.com/video/" . $videoid . "\" width=\"100%\" height=\"".$h."\" frameborder=\"0\" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
        ";
			}
...
<table>
	...
	<tr>
		...
		<td><input value='' type='text' class='".$shortcodeName."_video' name='".$shortcodeName."_video'><br />
			<div class='shortcode_video_example'>".__('Examples:','gt3_builder')."<br />
			".__('Youtube','gt3_builder')." - http://www.youtube.com/watch?v=6v2L2UGZJAM<br />
			".__('Vimeo','gt3_builder')." - http://vimeo.com/47989207</div>
		</td>
	</tr>
	<tr>
		<td>Float:</td>
...
shortcodesUI::getInstance()->add('video', array("name" => $shortcodeName, "caption" => "Video", "handler" => $gt3pb_compileShortcodeUI));
