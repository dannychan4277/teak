		...
		function shortcode_contacts($atts, $content = null) {
            ...
            if (is_array($gt3_theme_pagebuilder['modules'][$module_id]['contact_info_icons'])) {
                ...
                foreach ($gt3_theme_pagebuilder['modules'][$module_id]['contact_info_icons'] as $key => $value) {
                    ...
                    $compile .= "<li class='contact_info_item ".(($value['bcolor'] == "ffffff" && $value['fcolor'] == "2f2f2f") ? "alt" : "")."'><div class='contact_info_wrapper'><span class='contact_info_icon' style='background:#".$value['bcolor'].";'><i style='color:#".$value['fcolor']."' class='".$value['data-icon-code']."'></i></span>".$contact_content."</div></li>";
                }
                $compile .= "</ul>";
            }
			return $compile;
