				...
				<div class="promoblock_wrapper">
					<div class="promo_text_block">
						<div class="promo_text_block_wrapper">
							' . (isset($main_text) ? "<h2 ".(isset($main_text_color) && strlen($main_text_color)>0 ? "style='color:#".$main_text_color." !important;'" : "")." class='promo_text_main_title'>" . $main_text . "</h2>" : '') . '
							' . (isset($additional_text) ? "<h6 ".(isset($additional_text_color) && strlen($additional_text_color)>0 ? "style='color:#".$additional_text_color." !important;'" : "")." class='promo_text_additional_title'>" . $additional_text . "</h6>" : '') . '
						</div>
					</div>
                    ' . ((strlen($button_link) > 0 && strlen($button_text) > 0) ? '<div class="promo_button_block">'.do_shortcode('[custom_button style="btn_large btn_type4" icon="" target="_self" href="'.$button_link.'"]'.$button_text.'[/custom_button]').'</div>' : '') . '
                    <div class="clear"></div>
				</div>
			</div>
            ';
