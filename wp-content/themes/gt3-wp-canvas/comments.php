...
<div id="comments">
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            jQuery('.temp_submit_comment').html('<div class=\"send_this_comment shortcode_button btn_small btn_type1\"><span class=\"btn_text\">" . __('Submit', 'theme_localization') . "</span></div>');
    ...
    if (have_comments()) : ?>
        <h4 class="headInModule postcomment"><?php
            echo __('Comments', 'theme_localization') . ": "; ?></h4>
