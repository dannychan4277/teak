...
if ($comments_num == 1) {
    $comments_text = '' . __('Comment', 'theme_localization') . '';
} else {
    $comments_text = '' . __('Comments', 'theme_localization') . '';
}
?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="span4">
                                                    <div class="blogpost_share">
                                                        <a target="_blank"
                                                           href="http://pinterest.com/pin/create/button/?url=<?php echo get_permalink(); ?>&media=<?php echo (strlen($gt3_theme_featured_image[0]) > 0) ? $gt3_theme_featured_image[0] : gt3_get_theme_option("logo"); ?>"
