...
if (!post_password_required()) {
    ...
    <div class="fullscreen_block_grid_ajax">
        <div class="slider-wrapper">
            <?php
                echo do_shortcode(esc_attr($gt3_theme_pagebuilder['slider_code']));
            ?>
        </div>
    ...
    jQuery(window).load(function () {
        gt3_get_posts_grid_ajax("gt3_get_posts", "port", "' . gt3_get_theme_option("fw_port_per_page") . '", posts_already_showed, "portfolio_grid_ajax", "");
