    ...
    $compile_bloglisting .= '
        <div class="post_otput_container">
            ...
            <div class="readmore_cont">
                ' . do_shortcode("[custom_button style='btn_normal btn_type1' icon='' target='_self' href='" . get_permalink() . "']" . __('Read More<i class="icon-caret-right"></i>', 'theme_localization') . "[/custom_button]") . '
            </div>
            <div class="meta">
