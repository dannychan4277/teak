...
jQuery.fn.fs_gallery = function (fs_options) {
    ...
    if (fs_options.slides.length > 1) {
        if (fNextObj.attr('data-type') == 'image') {
            ...
            fNextObj.append('<iframe width="100%" height="100%" src="http://www.youtube.com/embed/' + fs_options.slides[1].src + '?controls=0&autoplay=1&showinfo=0&modestbranding=1&wmode=opaque&rel=0&hd=1&disablekb=1" frameborder="0" allowfullscreen></iframe>');
        } else {
            fNextObj.attr('style', 'background:url(' + fs_options.slides[1].thmb + ') no-repeat;');
            firstObj.append('<iframe src="http://player.vimeo.com/video/' + fs_options.slides[1].src + '?autoplay=1&loop=0&api=1&player_id=player' + fs_options.slides[1].uniqid + '" width="100%" height="100%" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>');
        }
    }
