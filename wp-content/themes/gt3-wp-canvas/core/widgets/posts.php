    ...
    function widget($args, $instance)
    {
        ...
        while ($wp_query_posts->have_posts()) : $wp_query_posts->the_post();
            ...
            if (has_post_thumbnail()) {
                $compilepopular .= '<div class="recent_posts_img"><img src="' . aq_resize($gt3_theme_featured_image_latest[0], "50", "50", true, true, true) . '" alt="' . get_the_title() . '"></div>';
            }
            ...
            $compilepopular .= '
                <div class="recent_posts_content">
					<div class="recent_posts_content_in">
						<a class="post_title" href="' . get_permalink() . '">' . get_the_title() . '</a><div class="clear"></div>
						<div class="pmeta">
						' . get_the_time("M d, Y") . '
						</div>
						<span class="divider">:</span>
						<span class="comments"><a href="' . get_comments_link() . '">'. get_comments_number(get_the_ID()) .' '. __('comments', 'theme_localization') .'</a></span>
					</div>
                </div>
                <div class="clear"></div>
			</li>
