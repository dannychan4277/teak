    ...
    <div class="ip">
        ...
        <div class="fr">
            <div class="share_page">
                <span class="share_text"><?php echo __('Share', 'theme_localization') ?></span>
                <span class="sh_fo_detail">
                    <a target="_blank" href="http://www.facebook.com/share.php?u=<?php echo get_permalink(); ?>" class="stand_icon share_facebook"></a>
                    ...
                    <a target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo get_permalink(); ?>&media=<?php echo (isset($gt3_theme_featured_image[0]) && strlen($gt3_theme_featured_image[0]) > 0) ? $gt3_theme_featured_image[0] : gt3_get_theme_option("logo"); ?>" class="stand_icon share_pinterest"></a>
