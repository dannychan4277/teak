...
<?php } else { ?>
	<div class="contentarea woocommerce_container woocommerce_fullscreen">    	
        <div class="fullscreen_shop_sorting">
            ...
            <div class="woo_def_sort_info"><i class="icon-sort"></i><?php echo __('Sorting', 'theme_localization'); ?></div>
            <div class="woo_cat_sort_info"><i class="icon-folder-close-alt"></i><?php echo __('Category', 'theme_localization'); ?></div>
            <div class="woo_price_sort_info"><i class="icon-dollar"></i><?php echo __('Price', 'theme_localization'); ?></div>            
		...
		<?php		
            ...
            wp_link_pages(array('before' => '<div class="page-link">' . __('Pages', 'theme_localization') . ': ', 'after' => '</div>'));
        ?>
        <div class="product_added_cart"><span><?php echo __('Product Added!', 'theme_localization'); ?></span></div> 
    </div>
