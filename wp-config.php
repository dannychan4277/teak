...
define('DB_USER', 'teak_man');

/** MySQL 資料庫密碼，請更改 "password_here" */
define('DB_PASSWORD', 'dK24BpN4GTauwwS9');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'v?OVf`!jxR`<Etg*n!U)[&eew`fyS+O&fH|wKun<K+%7?q*2ILJ}b{%-wAeMz<u_');
define('SECURE_AUTH_KEY',  'Oz$G+*jt36N6QE1]Q.]l8;N9ma+j*eS#9b!Qi6RU*w`+$yGMrj @BHlxlW_mn8ep');
define('LOGGED_IN_KEY',    '_Q$gSQdx#P6:-#.;pDqM9!<;IGQ^6RLcsT/F;gCFqw1[!BM9/cxS,16B`a-qNNl|');
define('NONCE_KEY',        'EL &{V#[S86|1j?1uv+|*|)W!s|nZX)8GJZ@T(<h8eiKd%G~p!H:(;F,|+>0_0kn');
define('AUTH_SALT',        '4^e;STe|J+Tx*.bV*/90|KN,N0aA1,%@<oU+|vL)Esg0T-Cre5lkC(hGj*;,c9S&');
define('SECURE_AUTH_SALT', '/P5^8CB>|+n!h&MvPJwv=+.-&v!k{a7Jp,$n!8MPR-MIUlSwR4=4Z=l>k-7FNl14');
define('LOGGED_IN_SALT',   '-XJkY|%B6yrT_V=)m<:9*m-CX<L--hs3k-!D FJkk5Dj sCn[pI7e$O#jQ(lhH`[');
define('NONCE_SALT',       'Qd.JwQt7MM(wNznqgOIsc=yOqdRzhEVK7qi7fb8IiG=Cz|/6^~/d|pqv:1;a3i,8');
